<template>
    <section :data-color="color.background" :class="blockClasses" :style="`--block-bg: ${color.background}; --block-fg: ${color.foreground}`" ref="block">
...
const blockClasses = computed(() => {
    ...
    return [bemm(), bemm('', divider), inView.value ? 'in-view' : 'out-view']
})

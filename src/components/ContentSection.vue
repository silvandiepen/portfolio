<template>
    <section :data-color="color.background" :class="blockClasses" :style="blockStyles" ref="block">
    ...
    &__divider {
        ...
        &--saw {
            &::before {
                ...
                background-image: linear-gradient(to right bottom, transparent 50%, var(--block-background) 50%);
        ...
        &--castle {
            &::before {
                background-image: linear-gradient(to right, transparent 50%, var(--block-background) 50%);
                background-size: calc(var(--spacing) * 2) var(--spacing);
                background-position: 0 0;
                background-repeat: repeat-x;

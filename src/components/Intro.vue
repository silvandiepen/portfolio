<template>
  <Hero
    ...
    :style="`--rotation: ${rotation}deg; --scrolled: ${scrolled}px`"
  >
    <div class="ring" ref="ring" :style="`--ring-color: ${ringColor}`">
      ...
      >
        <defs>
          <path
            id="textPath"
            d="M100 100 m -80, 0 a 80,80 0 0,1 160,0 a 80,80 0 0,1 -160,0"
          />
        </defs>
    ...
    <h4>
      I’m a Dad, Husband, Illustrator, Developer, Designer, Photographer and
      love to create good looking and working things.
    </h4>
  </Hero>
</template>

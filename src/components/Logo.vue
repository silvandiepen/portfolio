<template>
    <div :class="bemm()">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" width="320px" height="320px" viewBox="0 0 320 320" enable-background="new 0 0 320 320"
            xml:space="preserve">
...
svg:hover g.jiggle path {
    animation: jiggle 3s calc(var(--delay, 0) * 0.1s) infinite;
}

g.jiggle path:nth-child(1) {
    --delay: 1;
}

g.jiggle path:nth-child(2) {
    --delay: 2;
}

g.jiggle path:nth-child(3) {
    --delay: 3;
}

g.jiggle path:nth-child(4) {
    --delay: 4;
}
</style>